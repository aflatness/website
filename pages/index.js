      ...
      <section id={utilStyles.infoSection}>
        ...
        <div className={utilStyles.infoBlock}>
          ...
          <div className={utilStyles.techRow}>
            <b><u>Front-end:</u></b> JavaScript, React.js, HTML5, CSS3, Next.js, Vue.js
          </div>
          <div className={utilStyles.techRow}>
            <b><u>Back-end:</u></b> Node.js, Express, MongoDB, PostgresSQL, MySQL
          </div>
          <div className={utilStyles.techRow}>
            <b><u>Tools:</u></b> NPM, Webpack, Jest, Mocha, AWS EC2 & S3, Docker, Heroku, NGINX
          </div>
          <div className={utilStyles.techRow}>
            <b><u>Techniques:</u></b> Git Workflow, Agile development, Test Driven Development
          </div>
        </div>
      </section>
      {/* <section id={utilStyles.infoSection}>
